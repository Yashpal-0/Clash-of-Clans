...
from characters import spawnBarbarian, move_barbarians, spawnArcher,spawnSArcher, move_archers, move_sarchers, spawnDragon, move_dragons, spawnBalloon, move_balloons, clearTroops, spawnHealer, move_healers
