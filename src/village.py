...
class Village:
    ...
    def remove_wall(self, wall_obj):
        ...
        # for troop in troops:
        #     if(troop.position[0] == wall_obj.position[0] + 1 and troop.position[1] == wall_obj.position[1] + 1 ):
        #         troop.kill()
        #     elif(troop.position[0] == wall_obj.position[0] + 1 and troop.position[1] == wall_obj.position[1] - 1):
        #         troop.kill()
        #     elif(troop.position[0] == wall_obj.position[0] - 1 and troop.position[1] == wall_obj.position[1] + 1):
        #         troop.kill()
        #     elif(troop.position[0] == wall_obj.position[0] - 1 and troop.position[1] == wall_obj.position[1] - 1):
        #         troop.kill()
        #     elif(troop.position[0] == wall_obj.position[0] and troop.position[1] == wall_obj.position[1]):
        #         troop.kill()
