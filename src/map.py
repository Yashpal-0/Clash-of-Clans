...
def printMap(V):
    ...
    for arch in stealth_archers:
        ...
        map_matrix[a+1][b] = archColor(arch) + Fore.BLACK + 'AR'
        map_matrix[a][b+1] = archColor(arch) + Fore.BLACK + 'CH'
        map_matrix[a+1][b+1] = archColor(arch) + Fore.BLACK + 'ER'
    ...
    for dr in healers:
        ...
        map_matrix[a+1][b] = drColor(dr) + Fore.BLACK + 'ER'
        map_matrix[a][b+1] = drColor(dr) + Fore.BLACK + 'AL'
        map_matrix[a+1][b+1] = drColor(dr) + Fore.BLACK + 'S '
