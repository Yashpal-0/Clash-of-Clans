...
class Hut(Building):
    def __init__(self, position, V):
        ...
        self.health = 40 + 10*self.level
        self.max_health = 40 + 10*self.level
        self.type = 'hut'
...
class Cannon(Building):
    def __init__(self, position, V):
        ...
        self.V = V
        self.destroyed = False
        self.health = 60 + (self.level * 30)
        self.max_health = 60 + (self.level * 30)
        self.type = 'cannon'
...
class Wall(Building):
    ...
    def destroy(self):
        self.destroyed = True
        troops = barbarians + archers + stealth_archers + KoQ
        for troop in troops:
...
class TownHall(Building):
    def __init__(self, position, V):
        ...
        self.V = V
        self.destroyed = False
        self.health = 100 + 20 * self.level
        self.max_health = 100 + 20 * self.level
        self.type = 'townhall'
